...
function encrypt(rawText: string): string {
...
function decrypt(hexCiphertext: string): string {
...
export { encrypt, decrypt, hexToUint8Array, uint8ArrayToHex };
