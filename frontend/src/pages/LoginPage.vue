<template>
    <div class="screen max-w-lg mx-auto px-5 pt-10">
    <div class="flex flex-col justify-center p-6 sm:p-12">
      <div class="w-full max-w-md- space-y-8">
        ...
        <form @submit.prevent="handleSubmit" class="space-y-6">
          ...
          >
            <span v-if="!isLoggingIng">Sign Up</span>
            <template v-else>
        ...
        <div class="text-center">
          <p class="text-base-content/60">
            ...
            <RouterLink :to="{ name: 'Signup' }" class="text-primary">
              Create Account
            </RouterLink>
          </p>
        </div>
...
import { Loader2, Lock, Mail, MessageSquare } from "lucide-vue-next";
...
const handleSubmit = () => {
  ...
  if (success === true) login(formData.value);
};
